...
import EditAccount from './Editaccount';
    ...
    function UserDashboard() {
        ...
        console.log("ChangePass:", showResults.ChangePass === true)
        console.log("EditAccount:", showResults.EditAccount === true)
            ...
            {/* Sidebar */}
                ...
                <div className="sidebar-container">
                    ...
                    <ul className="sidebar-navigation">
                        ...
                        <li>
                        <Button href="#https://www.freecodecamp.org/" target="_blank" rel="noreferrer">
                            <i className="fa fa-tachometer" aria-hidden="true"></i> FreeCodeCamp
                        </Button>
                        </li>
                        <li>
                        <Button href="#https://teamtreehouse.com/" target="_blank" rel="noreferrer">
                            <i className="fa fa-users" aria-hidden="true"></i> TeamTreehouse
                        </Button>
                        </li>
                        <li>
                        <Button href="https://mec-tech.typingclub.com/" target="_blank" rel="noreferrer">
